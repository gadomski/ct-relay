      ...
      <Blockquote.Root>
        <Blockquote.Content>
          <Highlight query={"Kelly"} styles={KELLY}>
            ...
            areas. Just before and after each of these wilderness areas is where
            Kelly and I will exchange our baton and she will run through those
            sections, as those zones do not allow any wheels on the ground! The
            wilderness sections are especially beautiful and rugged!
          </Highlight>
        </Blockquote.Content>
        <Blockquote.Caption>
          —{" "}
